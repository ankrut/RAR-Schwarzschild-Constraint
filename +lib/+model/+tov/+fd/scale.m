...
EXPORT.raw.particleNumber	= lib.module.ProfileMapping(1,'M/m');
...
EXPORT.SI.particledensity = lib.module.ProfileMapping(...
	@(obj) EXPORT.SI.density.map(obj)/obj.data.m,...
	'\mathrm{m}^{-3}');

EXPORT.SI.particleNumber = lib.module.ProfileMapping(...
	@(obj) EXPORT.SI.mass.map(obj)/obj.data.m,...
	'');
...
EXPORT.SI.temperature = lib.module.ProfileMapping(...
